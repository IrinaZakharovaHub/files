...
define('api/init',['tools/dispatcher'], function(dispatcher) {
	...
	return function(state, options) {
		...
		state.version = '1149_3308_20181204';
...
define('api/fill',['tools/dispatcher'], function(dispatcher) {
    'use strict';
    return function(state, alias, data) {
        dispatcher.log({
            logType: 'fill',
            logData: {
                slide: state.currentSlide,
...
/* globals window */
define('main',['api/init', 'api/nav', 'api/attach', 'api/fire', 'api/fill', 'api/url', 'api/nextPres', 'api/prevPres', 'api/sendMail', 'api/showQuiz'], function(init, nav, attach, fire, fill, url, nextPres, prevPres, mail, showQuiz) {
    'use strict';
    ...
    communicate = {
        ...
        fillQuestionary: function fillQuestionary(alias, data) {
            fill(state, alias, data);
        },
