...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommunicateEmbedded = {
	    ...
	    setClientData: function setClientData(data) {
	        console.log('setClientData', data);
	    },
	    nextCallPresentation: function() {
	        console.log("nextCallPresentation");
	    },
	    prevCallPresentation: function() {
	        console.log("prevCallPresentation");
	    },
	    ...
	    fillQuestionary: function(alias, value) {
	        console.log("fillQuestionary:" + alias + ":" + value);
	    },
